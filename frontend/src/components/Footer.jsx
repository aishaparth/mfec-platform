...
export default function Footer() {
  return (
    <footer style={{ background: '#0D1B0E', color: 'rgba(255,255,255,0.75)', paddingTop: 48, marginTop: 'auto' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 36, paddingBottom: 40 }}>
          ...
          <div>
            ...
            <div style={{ marginTop: 14 }}>
              <span style={{ background: 'rgba(255,255,255,0.1)', borderRadius: 50, padding: '4px 12px', fontSize: '0.72rem', color: 'rgba(255,255,255,0.7)', fontWeight: 500 }}>
                PO-DS-AGRI-2026-27-01
              </span>
            </div>
          </div>
          ...
          {/* Analytics Pages */}
          <div>
            <h4 style={{ color: '#A5D6A7', fontSize: '0.82rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.8px', marginBottom: 14 }}>Analytics Modules</h4>
          ...
          {/* Project Info */}
          <div>
            <h4 style={{ color: '#A5D6A7', fontSize: '0.82rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.8px', marginBottom: 14 }}>Project Details</h4>
            <ul style={{ display: 'flex', flexDirection: 'column', gap: 8, fontSize: '0.82rem', color: 'rgba(255,255,255,0.65)' }}>
              ...
              <li><Link to="/data-sources" style={{ color: '#66BB6A', textDecoration: 'none', fontWeight: 500 }}>View Data Sources →</Link></li>
            </ul>
          </div>

          {/* Data Sources quick */}
          <div>
            <h4 style={{ color: '#A5D6A7', fontSize: '0.82rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.8px', marginBottom: 14 }}>Key Data Sources</h4>
            <ul style={{ display: 'flex', flexDirection: 'column', gap: 6, fontSize: '0.8rem', color: 'rgba(255,255,255,0.6)' }}>
              {['Sentinel-2 MSI (ESA Copernicus)', 'WorldClim v2.1', 'SRTM DEM 30m (NASA/USGS)', 'IMD Weather Stations', 'GBIF Occurrence Records', 'Survey of India Boundaries', 'MaxEnt v3.4.4', 'Google Earth Engine'].map(s => (
                <li key={s} style={{ display: 'flex', alignItems: 'flex-start', gap: 6 }}>
                  <span style={{ color: '#66BB6A', marginTop: 1 }}>·</span> {s}
                </li>
              ))}
            </ul>
          </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', padding: '20px 0', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
          ...
          <p style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.4)' }}>
            Geospatial Analysis Platform · PO-DS-AGRI-2026-27-01
          </p>
        </div>
      </div>
    </footer>
